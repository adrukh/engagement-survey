      ...
      <div className="bg-white border border-blue-100 rounded-xl shadow-sm p-8 mb-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="flex items-start space-x-3">
            ...
            <p className="text-gray-700">Each question makes a positive statement towards a value, asking for agreement or disagreement</p>
          </div>
          <div className="flex items-start space-x-3">
            <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
              <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <p className="text-gray-700">Results show the % of people who positively agree with the statements in question</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {survey.values.map((value, index) => (
              <div key={value.id} className="group hover:bg-gray-50 -mx-2 px-2 py-4 rounded-lg transition-colors">
